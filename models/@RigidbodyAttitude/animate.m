...
%     s.hload = plot3(xL(1,1), xL(2,1), xL(3,1), 'k.', 'LineWidth',lwl) ;
%     s.xLcom = plot3(xLcom(1,1,j), xLcom(1,2,j), xLcom(1,3,j), 'ko', 'LineWidth',lwl) ;
%     s.cable = plot3([wp_cable_attach(1) xL(1,:)], [wp_cable_attach(2) xL(2,:)], [wp_cable_attach(3) xL(3,:)], ':m','LineWidth',lwc) ;
